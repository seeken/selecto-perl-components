...
$t->get_ok('/explore/products')
    ...
    ->content_like(qr{/selecto-components/chart\.umd\.min\.js\?v=20260821-6})
    ->content_like(qr{/selecto-components/selecto-components\.css\?v=20260821-6})
    ->content_like(qr{/selecto-components/selecto-components\.js\?v=20260821-6})
