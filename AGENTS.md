...
- This repository owns the reusable Mojolicious exploration UI for native
  ...
  transport, server-rendered HTML fragments, and Perl-specific browser
  behavior. Shared theme and htmx artifacts are generated from the sibling
  `selecto-api-console` JavaScript workspace.
...
- The htmx runtime is vendored and version-pinned by
  `@selecto/web-assets`. Update both assets there, sync this distribution,
